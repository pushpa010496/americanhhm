...
//return "page is under development";
            ...
            $data = [
                ...
                'subject_admin' => "Qualtrics Healthcare Webinar registrations |".$request->email." | Americanhhm - Webinars",                      
            ];
            /*Admin mail*/
...
//return "page is under development";
           ...
           // $form->state = @$request->state ? @$request->state : 'NA';          
            ...
            $data = [
                ...
                'subject_admin' => "Registration for on demand webinar video |".$request->email." | Americanhhm - Webinars",                      
            ]; 
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
                $message->to(trans('messages.adminemail'));     
...
//return "page is under development";
           ...
           // $form->state = @$request->state ? @$request->state : 'NA';          
            ...
            $data = [
                ...
                'subject_admin' => "Hyland Webinar registrations |".$request->email." | Americanhhm - Webinars",                      
            ]; 
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
                $message->to(trans('messages.adminemail'));
           ...
           // $form->callfrom = $request->callfrom;                  
            ...
            $data = [
               ...
               // 'callfrom'=>$request->callfrom,               
                ...
                'subject_admin' => "Resmed webinar series |".$request->email." | Americanhhm - Webinars",                      
            ]; 
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
                $message->to(trans('messages.adminemail'));
           ...
           // $form->callfrom = $request->callfrom;                  
            ...
            $data = [
               ...
               // 'callfrom'=>$request->callfrom,               
                ...
                'subject_admin' => "Registration for Advantech |".$request->email." | Americanhhm - Webinars",                      
            ]; 
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
                $message->to(trans('messages.adminemail'));
      ...
      $countries = DB::table('countries')->get();
        if(\Request::isMethod('post')){    
            ...
            $data = [
                ...
                'subject_admin' => "Equinix Webinar | video Subscriber | Americanhhm ", 
           ...
           // $form->callfrom = $request->callfrom;                  
            ...
            $data = [
               ...
               // 'callfrom'=>$request->callfrom,               
                ...
                'subject_admin' => "Registration Successful | Advantech Healthcare   |".$request->email." | Americanhhm - Webinars",                      
            ]; 
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
                $message->to(trans('messages.adminemail'));
           ...
           // $form->callfrom = $request->callfrom;                  
            ...
            $data = [
               ...
               // 'callfrom'=>$request->callfrom,               
                ...
                'subject_admin' => "Registrations for  RESMED WEBINAR - TELEMONITORING HOME NIV PATIENTS |".$request->email." | Americanhhm - Webinars",                      
            ]; 
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
                $message->to(trans('messages.adminemail'));
        ...
        if(\Request::isMethod('post')){    
           ...
           // return "page is under development";
            ...
            $data = [
                ...
                'subject_admin' => "IT Predictions 2021 - ANZ Edition Webinar |".$request->email." | Americanhhm - Webinars",                      
            ];
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
                 $message->to(trans('messages.adminemail')); 
        ...
        if(\Request::isMethod('post')){    
           ...
           //return "page is under development";
            ...
            $data = [
                ...
                'subject_admin' => "Registrations for Barco Nio Fusion 12MP - On-demand Webinar. |".$request->email." | Americanhhm - Webinars",                      
            ];
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
                $message->to(trans('messages.adminemail')); 
        ...
        if(\Request::isMethod('post')){    
           ...
           // return "page is under development";
            ...
            $data = [
                ...
                'subject_admin' => "Thank you for your interest in Avalue Healthcare. |".$request->email." | Americanhhm - Webinars",                      
            ];
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
               $message->to(trans('messages.adminemail')); 
        ...
        if(\Request::isMethod('post')){    
           ...
           // return "page is under development";
            ...
            $data = [
                ...
                'type' =>$request->type,                            
                'country'=>$request->country, 
                'path'=>'https://industry.americanhhm.com/webinars/digitechhealthcare/orthoclinicaldiagnostics.mp4',               
                ...
                'subject_admin' => "Registration for Ortho Clinical Diagnostics On-demand Webinar |".$request->email." | Americanhhm - Webinars",                      
            ];
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
                 $message->to(trans('messages.adminemail')); 
        ...
        if(\Request::isMethod('post')){    
           ...
           // return "page is under development";
            ...
            $data = [
                ...
                'type' =>$formtype,                            
                'country'=>$request->country,                
                'path'=>'https://industry.americanhhm.com/webinars/digitechhealthcare/varian.mp4', 
                'client_message'=>$request->client_message,
                'subject_client' =>'Varian Medical Systems On demand Webinar',
                'subject_admin' => "Varian Medical Systems on demand Webinar |".$request->email." | Americanhhm - Webinars",                      
            ];
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
                 $message->to(trans('messages.adminemail')); 
      ...
      $countries = DB::table('countries')->get();
        if(\Request::isMethod('post')){    
            ...
            $data = [
                ...
                'type' =>$formtype,                            
                'country'=>$request->country,                
                'path'=> "https://industry.americanhhm.com/webinars/digitechhealthcare/iqvia.mp4",
                'client_message'=>$request->client_message,
                'email_updates' => $request->email_updates == ''? 'No': 'Yes',
                'representative' => $request->representative == ''? 'No': 'Yes',               
                'quotation' => $request->quotation == ''? 'No': 'Yes',
                'subject_client' =>'Digital Health: Using technology to engage with patients On-demand Webinar | Registration Successful',
                'subject_admin' => "Digital Health: Using technology to engage with patients On-demand Webinar |".$request->email." | Americanhhm - Webinars",                      
            ];
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
                 $message->to(trans('messages.adminemail')); 
        ...
        if(\Request::isMethod('post')){    
           ...
           // return "page is under development";
            ...
            $data = [
                ...
                'representative' => $request->representative == ''? 'No': 'Yes',               
                'quotation' => $request->quotation == ''? 'No': 'Yes',
                'path'=>"https://industry.americanhhm.com/webinars/digitechhealthcare/docdoc.mp4",
                'client_message'=>$request->client_message,
                'subject_client' =>'Data-driven Healthcare on-demand Webinar | Registration Successful',
                'subject_admin' => "Data-driven Healthcare on-demand Webinar |".$request->email." | Americanhhm - Webinars",                      
            ];
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
                 $message->to(trans('messages.adminemail')); 
          ...
          if(\Request::isMethod('post')){    
           ...
           // return "page is under development";
            ...
            $data = [
                ...
                'country'=>$request->country,                
                'type'=>$request->type,   
                'path'=>"https://industry.Americanhhm.com/webinars/smart-healthcare/smart-healthcare.mp4",
                'client_message'=>$request->client_message,
                'subject_client' =>'Registration for  Avalue smart healthcare On Demand webinar video | Registration Successful',
                'subject_admin' => " Avalue smart healthcare On Demand webinar video |".$request->email." | Americanhhm - Webinars",                      
            ];
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
                 $message->to(trans('messages.adminemail')); 
        ...
        if(\Request::isMethod('post')){    
           ...
           // return "page is under development";
            ...
            $data = [
                ...
                'subject_admin' => " Registrations for Uniphore RCM webinar |".$request->email." | Americanhhm - Webinars",                      
            ];
            /*Admin mail*/
            Mail::send('emails.webinars.admin', $data, function($message) use ($data) {
            $message->to(trans('messages.adminemail')); 
