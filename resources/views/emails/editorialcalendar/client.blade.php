          ...
          <tr>
            <td>
              ...
              <tr>
                ...
                Thank you for your interest in Editorial Calendar. <br>
                Hope you were able to get a copy. 

               </td>
              </tr>
              <tr>
                <td align="left" valign="middle" style="font-family: 'Roboto', sans-serif;font-size:13px;">Additionally, you may directly download the document by clicking the link below-
                 <br><a href="{{trans('messages.editorial_calendar_pdf')}}"><b>AmericanHHM Editorial Calendar</b></a> </td>
               </tr>
               <tr>
                 <td align="left" valign="middle" style="font-family: 'Roboto', sans-serif;font-size:13px;">
                <b> One of our subject matter expert will get in touch with you shortly.</b></td>
              </tr>
              <tr>
                <td align="left" valign="middle" style="font-family: 'Roboto', sans-serif;font-size:13px;">
                Should you face any technical difficulty in downloading/viewing the document please feel free to get in touch with us at editorial@americanhhm.com 
               </td>
             </tr>
            ...
            <tr>
              <td align="left" valign="middle" style="font-family: 'Roboto', sans-serif;font-size:13px;"><a href="<?php echo url('/');?>" title=" Team {{trans('messages.sitename')}}" target="_blank" style="color:#333333;"><b> Editorial Team@AmericanHHM</b></td>
              </tr>
            </table>
