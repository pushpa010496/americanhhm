...
<script src="https://www.google.com/recaptcha/api.js?render=6LftuekgAAAAAAP3oOBUbKrMly-Fkzek9aPC0JQq"></script>
<script> 
    grecaptcha.ready(function() {
      grecaptcha.execute('6LftuekgAAAAAAP3oOBUbKrMly-Fkzek9aPC0JQq', {action: 'submit'}).then(function(token) {
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
					...
					<h2 class="text-blue">Your Advertising Query was successfully submitted</h2>
                        <p class="text-blue">Thank you for your interest in AmericanHHM Advertising. Our team extends its gratitude for your interest.</p>
                        <p  class="text-blue">We look forward to approaching you soon. In the interim, please feel free to explore AmericanHHM by subscribing to our e-book and e-Newsletter. </p>
						...
						<div class="col-12 advert-bg min-hyt-580">
							<div class="row">
								<div class="col-lg-5 col-md-5 col-sm-6 col-12 pt-3">
									<h2 class="pt-3">Are your advertisements reaching the right people?</h2>
									<p class="text-left pt-2">Reach key decision makers at hospitals, medical laboratories and healthcare companies worldwide with highly targeted advertising in our magazine. This marketplace provides a chance for you to reach the right people with your message by reaching the right audience.</p>
									<p class="text-left pt-2">AmHHM magazine, written by doctors and hospital administrators, is a valuable resource for healthcare professionals.</p>
			...
			<div class="container" align="center">
				<div class="col-12 magz-bg pb-1">
					<h3 class="font-21 pb-0 pt-2 font-weight-bold">
						<a href="{{url('archives')}}" target="_blank" class="text-white">Our Healthcare & Pharmaceutical Publications</a>
					</h3>
					<div class="mt-3"> 
						<tr>
				...
				<div class="mt-3"> 
				<tr>
					<td ><a href="{{url('https://www.europeanhhm.com')}}" target="_blank">
