...
<ul>
    ...
    <li>Opportunity to have a say in shaping our future course of publications.</li>
			...
			<div class="ebook ">
				...
				<form action="{{route('getpublished.post')}}" method="Post" enctype="multipart/form-data">
					...
					<div class="form-group form-custom">
						...
						<div class='form-row'>
							...
							<div class="col-md-9 mb-2 pl-0">
								<input type="text" name="organisation" class="form-control" id="text" placeholder="" required>           
							</div>
							</div>
					...
					<div class="form-group">
						<div class="form-row">
							...
							<div class="col-md-9 col-sm-6 col-12 mb-3">
				...
				<p>American Hospital Healthcare Management would focus on American-centric B2B Healthcare Industry executives introducing them to
