              ...
              <div class="row form-container">
                  ...
                  <div class="col-lg-10 offset-lg-1"> 
                    ...
                    <form action="{{route('newsletter.post')}}" method="post" name="vtiger_form" method="post" id="writemessage" class="form_count" accept-charset="utf-8" _lpchecked="1">        
                      ...
                      <div class="form-group col-lg-12">
                        <div class="g-recaptcha" data-sitekey="6LftuekgAAAAAAP3oOBUbKrMly-Fkzek9aPC0JQq">
                          <div style="width: 304px; height: 78px;">
                            <div>
                              <iframe src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LftuekgAAAAAAP3oOBUbKrMly-Fkzek9aPC0JQq&amp;co=aHR0cHM6Ly93d3cuYXNpYW5oaG0uY29tOjQ0Mw..&amp;hl=en&amp;v=v1545073489967&amp;size=normal&amp;cb=9daq5uigdto6" role="presentation" name="a-2t3zzprf2o5y" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation" width="304" height="78" frameborder="0"></iframe>
                            </div>
