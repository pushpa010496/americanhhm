	...
	<div class="border mt-4 mb-4 p-4">
		<div class="row">
			<div class="col-lg-8 col-md-8 col-sm-8 col-12">	
				<h1 class="mb-4 PF-TXTRED mt-0">To get American Hospital and Healthcare Management, please fill out the following form:</h1>
				<div class="mb-2">
...
<!--
                  ...
                  <h3 style="color: green;" align="center"><u>Thank You!</u></h3>  
				  <h3 align="center">Your Magazine Subscription was Successful</h3> 
				 <p> <h4 align="center">
Thank you for subscribing AmericanHHM Magazine. Our team extends its gratitude for your interest in AmericanHHM Magazine. 
</h4>       </p>
...
<p>A world of Medical insights and industrial acumen awaits you!</p>             
			...
			<div class="ebook">
				...
				<form action="{{url('magazine-subscribe-post')}}" method="Post" enctype="multipart/form-data">	<input type="hidden" name="_token" value="{{ csrf_token() }}">
					...
					<h2 class="mb-2 PF-TXTRED">Are you curious to know more about products and services?</h2>
					<p>You can find ads in your copy of the American hospital and health management from leading industry players. If you want additional information from these companies on their products and services, simply check the boxes next to the topics of interest you and fax the form to +91 40 4961 4555.</p>
