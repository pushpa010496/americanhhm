...
<div class="container">
  <div class="row shadow">
    ...
    style="background-image: url('https://industry.americanhhm.com/images/Americanhhm-bg.jpg');    background-repeat: no-repeat;
...
<div>
<a href="{{url('e-newsletter')}}" target="_blank">
                  <button class="btn btn-sm btn-block btn-warning  font-weight-bold shadow" style="border-color:#002232; background-color:#1bb5c1; color:#f1f5f8;font-size: 14px;"> Subscribe to our monthly newsletter <br>for latest insights &amp; discoveries
</button>
      </a>
</div>
...
@foreach($banners as $k=>$homebanner12)   
    ...
    <div class="mt-3">
      ...
      {!! $homebanner12->script !!}
      @else
      <a href="{{$homebanner12->url}}" onclick="trackOutboundLink('{{$homebanner12->url}}'); return false;" target="_blank" title="{{$homebanner12->title}}">
            ...
            <li class="media PF-Brdrnone PF-BGnone text-white p-0 PF-TopArt-maxHyt">
              ...
              <div class="media-body pl-2 pt-1">
                <a href="{{url('articles').'/'.$val->url}}" title="{{$val->title_tag}}">
                  <h2 class="media-heading">{{\Illuminate\Support\Str::limit($val->title,$limit =140)}}</h2>
                </a>
