...
<!--
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-12 PF-LatestMagzBG mb-3">
    <a href="https://www.americanhhm.com/latest-ebook" target="_blank">
    <img src="https://industry.americanhhm.com/ebooks/issue-03/1650541853-ebook-sm-AHHM-56-sm.jpg" alt="Latest Issue" title="Latest Issue" width="145" class="img-fluid border mb-3">
...
<a {{$page_id}} href="{{$banner->url}}" onclick="trackOutboundLink('{{$banner->url}}'); return false;" target="_blank" class="mb-3" title="{{$banner->title}}"><img class="img-fluid div-shadow mb-3" src="{{config('app.url')}}ensign/{{$banner->image}}" alt="{{$banner->img_alt}}"  title="{{$banner->img_title}}"/></a>
